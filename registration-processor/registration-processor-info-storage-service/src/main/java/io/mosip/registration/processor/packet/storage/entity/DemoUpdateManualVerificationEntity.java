...
/**
 * The persistent class for the demo_update_manual_verification database table.
 *
 * @author magesh
 * @since 0.0.1
 *
 */
@Entity
@Table(name = "demo_update_manual_verification", schema = "regprc")
public class DemoUpdateManualVerificationEntity extends BasePacketEntity<DemoUpdateManualVerificationPKEntity> implements Serializable {
	 ...
	 */
	public DemoUpdateManualVerificationEntity() {
		super();
	}
